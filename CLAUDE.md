...
**Текущий этап:** Этап 1 — База данных  
**Последнее действие:** Этап 0 завершён — инфраструктура, бэкенд, фронтенд, деплой  
**Следующий шаг:** Написать SQL-миграцию таблицы `listings`, применить в Supabase
